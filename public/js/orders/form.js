...
/***/ "./resources/js/pages/orders/form.js":
/*!*******************************************!*\
  !*** ./resources/js/pages/orders/form.js ***!
  \*******************************************/
/*! no exports provided */
...
$(function () {
  ...
  $('#order-form').on('submit', function (e) {
    e.preventDefault();
    var form = _utils_request__WEBPACK_IMPORTED_MODULE_0__["getFormData"]($(e.currentTarget));
    _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
      method: 'post',
      url: '/orders',
      data: form
    }), function (res) {
      _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Dados do pedido inseridos.', function () {
        return location.href = '/orders/' + res.data.id;
      });
    });
  });
  $('#client-id').on('change', function (e) {
    ...
    if (t.val() != -1) {
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
        method: 'get',
        url: '/registers/addresses/get-list-by-client/' + t.val(),
        data: {}
      }), function (res) {
        $('#address-id').html('');
        $('#address-id').append("<option value=\"-1\">Retirada no Local</option>");
        $.each(res.data, function (key, value) {
          $('#address-id').append("<option value=".concat(value.id, ">").concat(value.street, ", ").concat(value.number, " - ").concat(value.district, ", ").concat(value.city.name, ", ").concat(value.city.state.name, " - CEP ").concat(value.zipcode, "</option>"));
        });
      });
    } else {
      $('#address-id').html('');
...
/***/ 15:
/*!*************************************************!*\
  !*** multi ./resources/js/pages/orders/form.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/orders/form.js */"./resources/js/pages/orders/form.js");
