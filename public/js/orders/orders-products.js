...
/***/ "./resources/js/pages/orders/orders-products.js":
/*!******************************************************!*\
  !*** ./resources/js/pages/orders/orders-products.js ***!
  \******************************************************/
/*! no exports provided */
  ...
  $('body').on('click', '.delete-product', function (e) {
    ...
    _utils_alert__WEBPACK_IMPORTED_MODULE_1__["deleteConfirm"](null, function () {
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
        method: 'delete',
        url: '/orders/products/' + t.data('id'),
        data: {}
      }), function () {
        _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Produto removido.');
      });
    });
  });
  $('#new-order-product').on('click', function () {
    _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
      method: 'get',
      url: '/orders/' + $('body #order-id').val() + '/products/create',
      data: {}
    }), function (res) {
      $.confirm({
        ...
        buttons: {
          confirm: {
            ...
            action: function action() {
              var form = this.$content.find('#product-form');
              var formData = _utils_request__WEBPACK_IMPORTED_MODULE_0__["getFormData"](form);
              formData.order_id = $('body #order-id').val();
              formData.quantity = formData.quantity.replace('.', '').replace(',', '.').trim();
              formData.price = formData.price.replace('.', '').replace(',', '.').trim();
              _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
                method: 'post',
                url: '/orders/products',
                data: formData
              }), function () {
                _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Produto adicionado ao pedido.');
              });
            }
          }
        },
        ...
        onContentReady: function onContentReady() {
          this.$content.find('#price, #quantity').mask("#.##0,00", {
            reverse: true
          });
        }
      });
...
/***/ 16:
/*!************************************************************!*\
  !*** multi ./resources/js/pages/orders/orders-products.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/orders/orders-products.js */"./resources/js/pages/orders/orders-products.js");
