  ...
  $('body').on('click', '.btn-delete', function (e) {
    ...
    _utils_alert__WEBPACK_IMPORTED_MODULE_1__["deleteConfirm"](null, function () {
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
        method: 'delete',
        url: '/orders/' + t.data('id'),
        data: {}
      }), function () {
        _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Pedido removido.');
      });
    });
  });
  $('body').on('click', '.btn-lock', function (e) {
    var t = $(e.currentTarget);
    _utils_alert__WEBPACK_IMPORTED_MODULE_1__["warningConfirm"]('Tem certeza que deseja concluir o pedido? Não será possível realizar modificações após está ação.', function () {
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
        method: 'patch',
        url: '/orders/' + t.data('id') + '/lock',
        data: {}
      }), function () {
        _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Ação realizada com sucesso.');
      });
    });
  });
});
...
/***/ 14:
/*!**************************************************!*\
  !*** multi ./resources/js/pages/orders/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/orders/index.js */"./resources/js/pages/orders/index.js");
