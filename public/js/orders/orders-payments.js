...
/***/ "./resources/js/pages/orders/orders-payments.js":
/*!******************************************************!*\
  !*** ./resources/js/pages/orders/orders-payments.js ***!
  \******************************************************/
/*! no exports provided */
  ...
  $('body').on('click', '.delete-payment', function (e) {
    ...
    _utils_alert__WEBPACK_IMPORTED_MODULE_1__["deleteConfirm"](null, function () {
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
        method: 'delete',
        url: '/orders/payments/' + t.data('id'),
        data: {}
      }), function () {
        _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Pagamento removido.');
      });
    });
  });
  $('#new-order-payment').on('click', function () {
    _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
      method: 'get',
      ...
      $.confirm({
        ...
        buttons: {
          confirm: {
            ...
            action: function action() {
              var form = this.$content.find('#payment-form');
              var formData = _utils_request__WEBPACK_IMPORTED_MODULE_0__["getFormData"](form);
              formData.order_id = $('body #order-id').val();
              formData.value = formData.value.replace('.', '').replace(',', '.').trim();
              _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
                method: 'post',
                url: '/orders/payments',
                data: formData
              }), function () {
                _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Pagamento informado com sucesso.');
              });
            }
          }
        },
        ...
        onContentReady: function onContentReady() {
          this.$content.find('#value').mask("#.##0,00", {
            reverse: true
          });
        }
      });
...
/***/ 18:
/*!************************************************************!*\
  !*** multi ./resources/js/pages/orders/orders-payments.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/orders/orders-payments.js */"./resources/js/pages/orders/orders-payments.js");
