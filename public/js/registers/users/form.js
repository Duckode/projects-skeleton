...
/***/ "./resources/js/pages/registers/users/form.js":
/*!****************************************************!*\
  !*** ./resources/js/pages/registers/users/form.js ***!
  \****************************************************/
/*! no exports provided */
...
$(function () {
  $('#user-form').on('submit', function (e) {
    ...
    if ($('#user-id').val() != undefined) {
      requestData = {
        method: 'put',
        url: '/registers/users/' + $('#user-id').val(),
      ...
      requestData = {
        method: 'post',
        url: '/registers/users',
        message: 'Dados do usuário inseridos.'
      };
    }
    ...
    _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
      ...
      _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"](requestData.message, function () {
        return location.href = '/registers/users/' + res.data.id + '/edit';
      });
    });
  });
});
...
/***/ 11:
/*!**********************************************************!*\
  !*** multi ./resources/js/pages/registers/users/form.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/registers/users/form.js */"./resources/js/pages/registers/users/form.js");
