...
/***/ "./resources/js/pages/registers/users/index.js":
/*!*****************************************************!*\
  !*** ./resources/js/pages/registers/users/index.js ***!
  \*****************************************************/
/*! no exports provided */
  ...
  $('body').on('click', '.btn-delete', function (e) {
    ...
    _utils_alert__WEBPACK_IMPORTED_MODULE_1__["deleteConfirm"](null, function () {
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
        method: 'delete',
        url: '/registers/users/' + t.data('id'),
        data: {}
      }), function () {
        _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"]('Usuário removido.');
      });
    });
  });
});
...
/***/ 10:
/*!***********************************************************!*\
  !*** multi ./resources/js/pages/registers/users/index.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/registers/users/index.js */"./resources/js/pages/registers/users/index.js");
