...
/***/ "./resources/js/pages/registers/plates/form.js":
/*!*****************************************************!*\
  !*** ./resources/js/pages/registers/plates/form.js ***!
  \*****************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $('#plate-form').on('submit', function (e) {
    ...
    if ($('#plate-id').val() != undefined) {
      requestData = {
        method: 'put',
        url: '/registers/plates/' + $('#plate-id').val(),
        message: 'Dados da placa atualizados.'
      };
    } else {
      requestData = {
        method: 'post',
        url: '/registers/plates',
        message: 'Dados da palaca inseridos.'
      };
    }
    ...
    _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
      ...
      _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"](requestData.message, function () {
        return location.href = '/registers/plates/';
      });
    });
  });
});
...
/***/ 7:
/*!***********************************************************!*\
  !*** multi ./resources/js/pages/registers/plates/form.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/registers/plates/form.js */"./resources/js/pages/registers/plates/form.js");
