...
/***/ "./resources/js/pages/registers/drivers/form.js":
/*!******************************************************!*\
  !*** ./resources/js/pages/registers/drivers/form.js ***!
  \******************************************************/
/*! no exports provided */
...
$('#driver-form').on('submit', function (e) {
  ...
  if ($('#driver-id').val() != undefined) {
    requestData = {
      method: 'put',
      url: '/registers/drivers/' + $('#driver-id').val(),
      message: 'Dados do motorista atualizados.'
    };
  } else {
    requestData = {
      method: 'post',
      url: '/registers/drivers',
      message: 'Dados do motorista inseridos.'
    };
  }
  ...
  _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
    ...
    _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"](requestData.message, function () {
      return location.href = '/registers/drivers/';
    });
  });
});
...
/***/ 5:
/*!************************************************************!*\
  !*** multi ./resources/js/pages/registers/drivers/form.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/registers/drivers/form.js */"./resources/js/pages/registers/drivers/form.js");
