...
/***/ "./resources/js/pages/registers/products/form.js":
/*!*******************************************************!*\
  !*** ./resources/js/pages/registers/products/form.js ***!
  \*******************************************************/
/*! no exports provided */
...
$(function () {
  $('#product-form').on('submit', function (e) {
    ...
    if ($('#product-id').val() != undefined) {
      requestData = {
        method: 'put',
        url: '/registers/products/' + $('#product-id').val(),
      ...
      requestData = {
        ...
        message: 'Dados do produto inseridos.'
      };
    }
    ...
    _utils_request__WEBPACK_IMPORTED_MODULE_0__["handle"](axios({
      ...
      _utils_alert__WEBPACK_IMPORTED_MODULE_1__["successReload"](requestData.message, function () {
        return location.href = '/registers/products';
      });
    });
  });
});
...
/***/ 13:
/*!*************************************************************!*\
  !*** multi ./resources/js/pages/registers/products/form.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/order-management/resources/js/pages/registers/products/form.js */"./resources/js/pages/registers/products/form.js");
